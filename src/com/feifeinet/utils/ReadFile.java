...
public class ReadFile {
	...
	private AssetFileDescriptor currentFD =null;
	/**
	...
	public ReadFile( AssetFileDescriptor fd)
	{
		mFile= null;
		mFilePath = null;
		currentFD = fd;
		mOffset=0;
		try {
			mDataInputStream = new DataInputStream(fd.createInputStream());
